...
@XmlRootElement(name = "RaportLiczbaMiejscowosciWiejskich")
public class RaportLiczbaMiejscowosciWiejskich {

    @XmlElementRef(name = "dataStanu", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
